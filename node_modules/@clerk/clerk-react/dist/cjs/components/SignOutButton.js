...
const SignOutButton = (0, import_withClerk.withClerk)(
  ({ clerk, children, ...props }) => {
    const { signOutCallback, signOutOptions, ...rest } = props;
    children = (0, import_utils.normalizeWithDefaultValue)(children, "Sign out");
    const child = (0, import_utils.assertSingleChild)(children)("SignOutButton");
    const clickHandler = () => {
