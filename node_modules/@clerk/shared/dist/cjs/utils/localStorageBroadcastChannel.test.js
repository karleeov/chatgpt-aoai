"use strict";
var import_localStorageBroadcastChannel = require("./localStorageBroadcastChannel");
const bcName = "clerk";
describe("LocalStorageBroadcastChannel", () => {
  ...
  it("notifies other LocalStorageBroadcastChannel with same name", () => {
    ...
    const tab1ClerkBC = new import_localStorageBroadcastChannel.LocalStorageBroadcastChannel(bcName);
    const tab1DifferentBC = new import_localStorageBroadcastChannel.LocalStorageBroadcastChannel("somethingElse");
    const tab2ClerkBC = new import_localStorageBroadcastChannel.LocalStorageBroadcastChannel(bcName);
