"use strict";
var import_multiDomain = require("./multiDomain");
...
describe("handleValueOrFn(opts)", () => {
  it.each([
    ...
    expect((0, import_multiDomain.handleValueOrFn)(key, url)).toBe(expected);
  });
});
describe("handleValueOrFn(opts) with defaults", () => {
  it.each([
    ...
    expect((0, import_multiDomain.handleValueOrFn)(key, url, defaultValue)).toBe(expected);
  });
});
