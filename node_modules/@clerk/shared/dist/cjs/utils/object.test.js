...
describe("camelToSnakeKeys", () => {
  it("creates a copy and does not modify the original", () => {
    ...
    const res = (0, import_object.deepSnakeToCamel)(original);
  ...
  it("transforms camelCased keys to snake_cased", () => {
    expect((0, import_object.deepCamelToSnake)({ key: 1, anotherKey: 2 })).toStrictEqual({
      key: 1,
      another_key: 2
    });
    expect(
      (0, import_object.deepCamelToSnake)({
        key: 1,
        anotherKey: 2,
  ...
  it("handles null and undefined values", () => {
    expect((0, import_object.deepCamelToSnake)({ key: 1, anotherKey: null })).toStrictEqual({
      key: 1,
      another_key: null
    });
    expect(
  ...
  it("transforms and removes camelCased keys", () => {
    const sampleObject = (0, import_object.deepCamelToSnake)({ key: 1, anotherKey: 2 });
  ...
  it("deeply transforms objects and arrays to camelCase", () => {
    ...
    const res = (0, import_object.deepSnakeToCamel)(sample);
    expect(res).toStrictEqual(expected);
  });
  it("prioritizes the camelCased property", () => {
    const sampleObject = (0, import_object.deepCamelToSnake)({ oneKey: 1, one_key: 2 });
    const anotherSampleObject = (0, import_object.deepCamelToSnake)({ one_key: 2, oneKey: 1 });
